...
const sections = [
  ...
  },
  {
    ...
    content: (
      <ol className="list-decimal list-inside space-y-1 text-sm text-stone-700 dark:text-stone-300">
  ...
  },
  {
    ...
    content: (
      <div className="text-sm text-stone-700 dark:text-stone-300 space-y-2">
        <p>Call <strong>Battleborn</strong> first: <a href="tel:+17756223448" className="text-emerald-700 dark:text-emerald-400 hover:underline">775-622-3448</a> (Pacific).</p>
